...
#define ServoWaitTime 500
#define nSamples 3
#define MotorTurnTime 730
#define ForwardTurn 70
#define BackwardTurn -55
#define MotorForwardTime 1200
#define MotorForwardSpeed 100
#define MotorReverseTime 800
#define MotorReverseSpeed -70
#define ForwardThresholdDistance 40
...
int sampleDistance() {
	...
	for (int i = 0; i < nSamples; i++) {
		while ((val = SensorValue(sonarInput)) < 0) {
			wait1Msec(40);
		}
		avg += val; // Sample Sonar
	}
	return avg / nSamples;
}
...
void inchReverse() {
	motor[leftMotor] = motor[rightMotor] = -80;
	wait1Msec(250);
	stopMovement();
}
